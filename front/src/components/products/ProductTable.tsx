...
const ProductTable: React.FC = () => {
    ...
    const handleSellMultiple = async () => {
        ...
        setIsProcessingSale(true); // Show loading state

        try {
            // Ensure selectedProducts contains the correct products
            console.log('Selected products:', selectedProducts);

            // Call the API to sell the selected products
            await sellMultipleProducts(selectedProducts);

            // Reload products after selling
            loadProducts();

            // Reset the selected products after the sale
            setSelectedProducts([]);
        } catch (error: any) {
            setError(error.message || 'Failed to sell products');
            console.error('Error selling products:', error);
        } finally {
            setIsProcessingSale(false); // Hide loading state
        }
    };

...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> sellMultipleProducts(@RequestBody
                                                              List<ProductDto>
                                                                          products){

        List<Product> multiple_products = productService.sellMultipleProducts(products);

        return ResponseEntity.status(HttpStatus.OK).body(multiple_products);
